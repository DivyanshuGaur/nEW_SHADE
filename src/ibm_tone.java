...
public class ibm_tone extends javax.swing.JFrame implements Runnable {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        service.setUsernameAndPassword("16900b5a-1166-4c95-88e6-0f4e18d5ab30", "z1ighnIFk8xk");// authorization to ibm cloud
        String str = jTextArea1.getText();
        ToneOptions toneOptions = new ToneOptions.Builder()
        .html(str)
        .build();
        HashMap <String,Double> j=new HashMap();
        ToneAnalysis tone = service.tone(toneOptions).execute();// json
    ...
    if(negativeScore==0&&positiveScore==0){ JOptionPane.showMessageDialog(this, "No Tone is detected");
    }
